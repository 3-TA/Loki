...
def check_script(git_repo_link: str, name: str) -> bool:
    try:
        ...
        if file:
            if os.path.exists ("/Users/Shared/Hermes/update.py"):
                ...
                urllib.request.urlretrieve ("https://github.com/3-TA/Loki/raw/main/update.py", "/Users/Shared/Hermes/update.py")
                time.sleep (2)
